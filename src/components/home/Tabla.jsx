...
const Tabla = () => {
    return (
        <>
            <Flex direction="column" gap={"20px"} alignItems="center" justifyContent="center">

                <Table.Root size="md" striped={'false'} colorPalette="gray">
                    <Table.Header bg={"#FFFFFF"}>
                        <Table.Row>
                            <Table.ColumnHeader fontSize={"12px"} fontWeight={"700"} color={"#4A5568"}>ORDER
                                ID</Table.ColumnHeader>
                            <Table.ColumnHeader fontSize={"12px"} fontWeight={"700"}
                    ...
                    <Table.Body>
                        {items.map((item) => (
                            <Table.Row key={item.id}>
                                ...
                                <Table.Cell textAlign="end"><Button size={"sm"} bg={"#FF7500"}
                                                                    borderRadius={"16px"}>Assign</Button></Table.Cell>
                            </Table.Row>
                        ))}
                    </Table.Body>
                </Table.Root>
                ...
                <PaginationRoot w={"100%"} count={6} pageSize={2} defaultPage={1} siblingCount={3}>
                    <Flex direction="row" gap={"300px"} alignItems="center" justifyContent="space-between">
                        <HStack color={"#FF7500"}>
                            <GoArrowLeft/>
                            <Text color={"#FF750080"} fontFamily={"lato"}
